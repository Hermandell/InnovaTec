        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-2 text-lg text-gray-600">
              ...
              creados por estudiantes, y elegir uno para continuar su desarrollo
              junto al antiguo propietario. Para comenzar, regístrate con tu
              cuenta de estudiante y navega a través de nuestra lista de
              proyectos en curso. Cada proyecto incluirá una breve descripción,
              el nombre del antiguo propietario y una lista de tareas pendientes
              por realizar.
              <br />
              Nuestro sitio web también cuenta con una sección de seguimiento de
              proyectos donde podrás actualizar el progreso del proyecto,
              compartir ideas y hacer comentarios sobre el trabajo en curso. De
              esta manera, podrás mantenerte al día con los avances del proyecto
              y trabajar en colaboración con el antiguo propietario.
            </p>
          </div>
                ...
                <div className="text-sm leading-6">
                  <p className="mt-3 font-semibold text-gray-900">
                    <Link>
                      ...
                      Contacto:
                      <br />
                      <span>Numero: {item.contact.number}</span>
                      <br />
                      <span>Email: {item.contact.email}</span>
                      <br />
                      <span>Archivos: {item.download}</span>
                    </Link>
                  </p>
